...
func TestParseL2Message(t *testing.T) {
	jsonFile, err := testhelpers.GetMsgFromFile("../../testhelpers/testdata/coinbasepro/test-l2-snapshot-response.json")
	if err != nil {
...
func BenchmarkL2MessageJSON(b *testing.B) {
	jsonFile, err := testhelpers.GetMsgFromFile("../../testdata/coinbasepro/test-l2-snapshot-response.json")
	if err != nil {
